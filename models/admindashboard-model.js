...
module.exports={
	...
	adminInsert: function(data,callback)
	{
		...
		var param=[data.name,data.username,data.email,data.phone,passwordHash.generate(data.password),data.gender,data.dob,data.nid,data.presentaddress,data.parmanentaddress];
